...
class Record(models.Model):
    ...
    waste_code = models.CharField(blank=True, null=True,
                                  choices=EWC_CHOICES,max_length=500)
    ...
    recycling_method = models.CharField(null=True, blank=True, choices=RECYCLING_METHOD_CHOICES,max_length=500)
    tags = models.ManyToManyField('Tag', blank=True)
    disposal_method = models.CharField(null=True, blank=True, choices=DISPOSAL_METHOD_CHOICES,max_length=500)
    type_of_waste = models.CharField(null=True, blank=True, choices=WASTE_TYPE_CHOICES, max_length=500)
